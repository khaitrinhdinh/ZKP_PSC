...
template Selector() {
    // Logic:
    // Chọn left/right based on path bit
    // Tránh if-else (không có trong ZK) bằng multiplication tricks
...
template MerkleProof(depth) {
    // Logic: 
    // Hash từ leaf lên root, verify với expected root
    // Verify rằng 1 leaf exists trong Merkle tree
    // Input: 
    // lemma[] (siblings), path[] (directions)
